      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <Link href="/admin/problems/create">
            <button className="w-full px-6 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition shadow-lg hover:shadow-xl font-semibold text-lg flex items-center justify-center gap-3">
